        ...
        <div className="w-[45%]">
          <div className="bg-gradient-to-r from-gray-700 to-gray-800 rounded-2xl shadow-lg p-6 flex flex-col items-center transform hover:scale-105 transition-transform duration-200 ease-out">
            ...
            <input
              ...
              className="w-full p-2 mb-4 border border-gray-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-gray-900 text-white placeholder-gray-500"
            />
            <button
              onClick={handleScrape}
              className="px-4 py-2 text-white bg-indigo-600 rounded-lg hover:bg-indigo-500 w-full transition-colors duration-200 ease-in-out"
            >
              Scrape
            </button>
          </div>
